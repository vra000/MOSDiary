...
MOSDiary предоставляет удобный типизированный интерфейс к данным электронного дневника [Московской Электронной Школы](https://school.mos.ru/). Библиотека построена на `asyncio` и возвращает готовые модели [Pydantic](https://pydantic.dev/docs/validation/latest/).
